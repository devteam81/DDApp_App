...
public class VideoPageDDActivity extends BaseActivity implements DownloadCompleteListener,
    ...
    private static final String TAG = VideoPageDDActivity.class.getSimpleName();
...
//    private SubtitlesSelectionHelper subtitlesSelectionHelper;
    ...
    private View.OnClickListener needToSubscribeToDownloadListener = v -> new AlertDialog.Builder(this)
            ...
            .setPositiveButton(getString(R.string.yes), (dialog, which) -> {
                ...
                {
                    Intent needPaymentIntent = new Intent(VideoPageDDActivity.this, PayPerViewPlansActivity.class);
                    needPaymentIntent.putExtra("Video", video);
                    startActivity(needPaymentIntent);
                }else {
                    Intent needPaymentIntent = new Intent(VideoPageDDActivity.this, PlansActivity.class);
                    startActivity(needPaymentIntent);
                }
            })
    ...
    private View.OnClickListener downloadVideoListener = v -> {
        ...
        if (resolutions!=null && resolutions.size() == 0)
            ...
            if(NetworkUtils.isNetworkConnected(VideoPageDDActivity.this))
                downloadVideo(resolutions.get(0).getUrl());
            else
                UiUtils.showShortToast(VideoPageDDActivity.this, getString(R.string.check_internet));
        }
        else {
            if (Status.PAUSED == PRDownloader.getStatus(downloadID)) {
                PRDownloader.resume(downloadID);
...
//            .setNegativeButton(getString(R.string.no), null)
    ...
    Runnable mVolRunnable=new Runnable() {
        ...
        public void run() {
            ...
            Animation fadeOut = AnimationUtils.loadAnimation(VideoPageDDActivity.this, R.anim.fade_out);
    ...
    Runnable mRatingRunnable=new Runnable() {
        ...
        public void run() {
            // TODO Auto-generated method stub
            Animation slide_down_fade_out  = AnimationUtils.loadAnimation(VideoPageDDActivity.this, R.anim.slide_down_fade_out);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_page_dd);
        ButterKnife.bind(this);
        UiUtils.log(TAG,"VideoPageDDActivity");
        ...
        rlThumbnail.setLayoutParams(ResponsivenessUtils.getLayoutParamsForFullWidthSeasonView(this));
...
//        }
    ...
    public void onResume() {
        ...
        filter.addAction(VideoPageDDActivity.ACTION_DOWNLOAD_UPDATE);
    ...
    private void loadVideoData(int adminVideoId) {
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (videoResponse != null) {
                    if (videoResponse.optString(SUCCESS).equals(Constants.TRUE)) {
                        ...
                        UiUtils.showShortToast(VideoPageDDActivity.this, videoResponse.optString(ERROR_MESSAGE));
                        finish();
                    }
                }
            }
            ...
            public void onFailure(Call<String> call, Throwable t) {
                ...
                nestedScrollVideoPage.setVisibility(View.VISIBLE);
                finish();
                NetworkUtils.onApiError(VideoPageDDActivity.this);
            }
        });
    }
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (genreTrailerResponse != null) {
                    if (genreTrailerResponse.optString(SUCCESS).equals(Constants.TRUE)) {
                        ...
                        UiUtils.showShortToast(VideoPageDDActivity.this, genreTrailerResponse.optString(ERROR_MESSAGE));
                    }
                }
            }
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (suggestionVideosResponse != null) {
                    ...
                    if (suggestionVideosResponse.optString(SUCCESS).equals(Constants.TRUE)) {
                        ...
                        UiUtils.showShortToast(VideoPageDDActivity.this, suggestionVideosResponse.optString(ERROR_MESSAGE));
                    }
                }
            }
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (seasonVideoResponse != null) {
                    if (seasonVideoResponse.optString(SUCCESS).equals(Constants.TRUE)) {
                        ...
                        //UiUtils.showShortToast(VideoPageDDActivity.this, seasonVideoResponse.optString(ERROR_MESSAGE));
                    }
                }
            }
    ...
    private void showVideoData() {
        ...
        txt_share_url.setText(shareVideoGenerateUrl());
        ...
        for (int i = 0; i < casts.size(); i++) {
            ...
            ClickableSpan clickableSpan = new ClickableSpan() {
                ...
                public void onClick(View textView) {
                    Intent toCast = new Intent(VideoPageDDActivity.this, CastVideosActivity.class);
...
/*        SpannableString castStr = new SpannableString(castsString);
                ...
                if(!isAdultAccepted)
                    ...
                    if (!PrefUtils.getInstance(this).getBoolanValue(PrefKeys.IS_LOGGED_IN, false)) {
                        ...
                        if (!video.getUserType().equalsIgnoreCase("1")) {
                            getUserLoginStatus(VideoPageDDActivity.this);
                            playTrailer();
                        } else {
                            startActivity(new Intent(getApplicationContext(), PlansActivity.class));
                        }
                ...
                switch (video.getVideoType()) {
                    ...
                    case VIDEO_OTHER:
                        if (!PrefUtils.getInstance(this).getBoolanValue(PrefKeys.IS_LOGGED_IN, false)) {
                            ...
                            else*/ if (!video.getUserType().equalsIgnoreCase("1")) {
    ...
    private void shareVideoButton() {
        ...
        String shareUrl = shareVideoGenerateUrl();
    ...
    private String shareVideoGenerateUrl(){
        String shareUrl = video.getShareUrl();
        if(PrefUtils.getInstance(this).getBoolanValue(PrefKeys.IS_LOGGED_IN, false)) {
            String encodedBase64Key = Crypt.encodeKey(SECRET_KEY);
            UiUtils.log(TAG,"EncodedBase64Key = " + encodedBase64Key);
    ...
    @OnClick({R.id.playVideoBtn,R.id.videoThumbnail})
                ...
                if (spamReasonsResponse != null) {
                    if (spamReasonsResponse.optString(SUCCESS).equals(Constants.TRUE)) {
                        ...
                        if (reasons != null && reasons.length > 0) {
                            ...
                            new AlertDialog.Builder(VideoPageDDActivity.this)
                        ...
                        UiUtils.showShortToast(VideoPageDDActivity.this, spamReasonsResponse.optString(ERROR_MESSAGE));
                    }
                }
            }
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (addToSpamResponse != null) {
                    if (addToSpamResponse.optString(SUCCESS).equals(Constants.TRUE)) {
                        UiUtils.showShortToast(VideoPageDDActivity.this, addToSpamResponse.optString(MESSAGE));
                        finish();
                    } else {
                        UiUtils.showShortToast(VideoPageDDActivity.this, addToSpamResponse.optString(ERROR_MESSAGE));
                    }
                }
            }
    ...
    public void choosePlanDialog() {
        Dialog dialog = new Dialog(VideoPageDDActivity.this, R.style.AppTheme_NoActionBar);
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (paymentObject != null) {
                    if (paymentObject.optString(APIConstants.Params.SUCCESS).equals(APIConstants.Constants.TRUE)) {
                        Toast.makeText(VideoPageDDActivity.this, paymentObject.optString(MESSAGE), Toast.LENGTH_SHORT).show();
                        invoice.setPaymentId(paymentId);
                        onPaymentSucceeded(invoice);
                    } else {
                        UiUtils.hideLoadingDialog();
                        Toast.makeText(VideoPageDDActivity.this, paymentObject.optString(ERROR_MESSAGE), Toast.LENGTH_SHORT).show();
                    }
                }
            }
...
//            }
                        ...
                        .setOnFinishListener(new ElasticFinishListener() {
                            ...
                            public void onFinished() {
                                ...
                                switch (type.toLowerCase()) {
                                    case "media":
                                        Intent i = new Intent(VideoPageDDActivity.this, VideoPageDDActivity.class);
                                    ...
                                    default:
                                        ...
                                        {
                                            Toast.makeText(VideoPageDDActivity.this, getResources().getString(R.string.something_went_wrong),Toast.LENGTH_SHORT).show();
                                            UiUtils.log(TAG, Log.getStackTraceString(e));
                                        }
    ...
    private void initExoPlayer() {
        ...
        trackSelector = new DefaultTrackSelector(VideoPageDDActivity.this, videoTrackSelectionFactory);
...
//        subtitlesSelectionHelper = new SubtitlesSelectionHelper(trackSelector, videoTrackSelectionFactory);
        ...
        for(int i=0; i<timers.size();i++) {
            ...
            playerMessages.add(player.createMessage(
                            (messageType, payload) -> {
                                ...
                                Animation slide_up_fade_in = AnimationUtils.loadAnimation(VideoPageDDActivity.this, R.anim.slide_up_fade_in);
                                ll_exo_rating.startAnimation(slide_up_fade_in);
                                slide_up_fade_in.setAnimationListener(new Animation.AnimationListener() {
                                    @Override
                                    public void onAnimationStart(Animation animation) {
                                        /*Animation slide_up = AnimationUtils.loadAnimation(VideoPageDDActivity.this, R.anim.slide_up);
    ...
    private void showDownloadResolutionDialog(ArrayList<DownloadUrl> downloadUrls) {
        ...
        if (!video.getUserType().equalsIgnoreCase("1") || video.getIsTrailerFree()==1) {
            ...
            final Dialog dialog = new Dialog(VideoPageDDActivity.this);
        ...
        exoLock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /*if(mExoPlayerIsLocked)
                {
                    ...
                    //exoLock.setColorFilter(ContextCompat.getColor(VideoPageDDActivity.this, R.color.white), android.graphics.PorterDuff.Mode.SRC_IN);
                ...
                //exoUnLock.setColorFilter(ContextCompat.getColor(VideoPageDDActivity.this, R.color.colorPrimaryHeaderPink), android.graphics.PorterDuff.Mode.SRC_IN);
