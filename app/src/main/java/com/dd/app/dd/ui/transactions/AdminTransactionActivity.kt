...
import com.dd.app.R
import com.dd.app.databinding.ActivityAdminTransactionBinding
...
import com.dd.app.dd.ui.wallet.AdminInvoiceAdapter
...
class AdminTransactionActivity : AppCompatActivity() {
    ...
    companion object{
        private val TAG  = AdminTransactionActivity::class.simpleName.toString()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_admin_transaction)
    ...
    private fun observeViewModel() {
        ...
        if(LoginUser.role.equals(ApiConstants.ADMIN,true)){
            ...
            walletDetailModel.adminTransactionsForInvoice(this, jsonObject.toString().toRequestBody())!!.observe(this, Observer {
                ...
                if(jsonInString.length>2) {
                    ...
                    invoiceList = ParseResponseData.parseAdminInvoice(mJSONArray)
                }

                val tempInvoiceList = invoiceList

                binding.rvVideoTransactions.layoutManager = LinearLayoutManager(this)
                binding.rvVideoTransactions.adapter = AdminInvoiceAdapter(tempInvoiceList) { selectedItem: Invoice ->
                    listItemClicked(
                        selectedItem
                    )
                }
