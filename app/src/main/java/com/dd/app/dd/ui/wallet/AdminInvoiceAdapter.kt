...
import com.dd.app.R
import com.dd.app.databinding.ItemAdminInvoiceBinding
import com.dd.app.databinding.ItemInvoiceBinding
import com.dd.app.dd.model.Invoice

class AdminInvoiceAdapter(private val invoiceList: List<Invoice>, private val clickListener: (Invoice) -> Unit) : RecyclerView.Adapter<ViewHolderAdminInvoice>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderAdminInvoice {
        val layoutInflater = LayoutInflater.from(parent.context)
        val binding: ItemAdminInvoiceBinding = DataBindingUtil.inflate(layoutInflater,
            R.layout.item_admin_invoice,parent,false)
        return ViewHolderAdminInvoice(binding)
    }

    override fun onBindViewHolder(holder: ViewHolderAdminInvoice, position: Int) {
...
class ViewHolderAdminInvoice(private val binding: ItemAdminInvoiceBinding) : RecyclerView.ViewHolder(binding.root)
{
